...
if __name__ == "__main__":
    ...
    #print("Total files (breached files):", count_files("breach_data")) # 31759
    ...
    print("Total Infected Files (breached files):", len(find_infected_files("breach_data"))) # 9497

    ## 5. Determine how many files were corrupted by department
    print("Finance Department Infected Files:", len(find_infected_files("breach_data/Finance")))
    print("HR Department Infected Files:", len(find_infected_files("breach_data/HR")))
    print("Sales Department Infected Files:", len(find_infected_files("breach_data/HR_1")))
